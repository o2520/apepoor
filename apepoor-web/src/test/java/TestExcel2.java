...
public class TestExcel2 {
    ...
    public static void main(String[] args) {
        ExcelReader reader0 = ExcelUtil.getReader("/Users/youguoqiang/Downloads/area1.xls");
        reader0.setSheet(0);
        List<AreaDTO> all0 = reader0.readAll(AreaDTO.class);
        ExcelReader reader1 = ExcelUtil.getReader("/Users/youguoqiang/Downloads/area1.xls");
        reader1.setSheet(1);
